...
class Respondent(models.Model):
    ...
    phone = models.ManyToManyField('Phone',  verbose_name='Телефон', related_name='respondent', null=False, blank=True)
    email = models.ManyToManyField('Email',  verbose_name='Email', related_name='respondent', null=True, blank=True)
