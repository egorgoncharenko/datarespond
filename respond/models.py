...
class Respondent(models.Model):
    ...
    phone = models.ManyToManyField('Phone', on_delete=models.CASCADE, verbose_name='Телефон', related_name='respondent', null=False, blank=True)
    email = models.For('Email', on_delete=models.CASCADE, verbose_name='Email', related_name='respondent', null=True, blank=True)
